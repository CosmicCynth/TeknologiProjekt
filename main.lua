function love.load()
    ...
    sceneTable.mainMenu.senesteBudget = {}
    sceneTable.mainMenu.senesteBudget.x = 200
    sceneTable.mainMenu.senesteBudget.y = 340
    sceneTable.mainMenu.senesteBudget.radius = 64

    sceneTable.mainMenu.dagensTip = {}
    sceneTable.mainMenu.dagensTip.x = 200
    sceneTable.mainMenu.dagensTip.y = 480
    sceneTable.mainMenu.dagensTip.radius = 65
...
function love.draw()
    ...
    if scene == "mainMenu" then
        ...
        love.graphics.circle("fill",sceneTable.mainMenu.senesteBudget.x,sceneTable.mainMenu.senesteBudget.y,sceneTable.mainMenu.senesteBudget.radius)
        love.graphics.circle("fill",sceneTable.mainMenu.dagensTip.x,sceneTable.mainMenu.dagensTip.y,sceneTable.mainMenu.dagensTip.radius)
...
function love.mousereleased(x,y,button)
    if button == 1 then
        ...
        if scene == "mainMenu" then
            ...
            mouseToTarget1 = distanceBetween(x,y,sceneTable.mainMenu.senesteBudget.x,sceneTable.mainMenu.senesteBudget.y)
            mouseToTarget2 = distanceBetween(x,y,sceneTable.mainMenu.dagensTip.x,sceneTable.mainMenu.dagensTip.y)
            if mouseToTarget < sceneTable.mainMenu.burgerMenu.radius and timer >= maxTimer then
                timer = 0
                sceneTxt = "Burger Menu"
                scene = "burgerMenu"
            elseif mouseToTarget1 < sceneTable.mainMenu.senesteBudget.radius and timer >= maxTimer then
                timer = 0
                sceneTxt = "Budget menu"
                scene = "budget"
            elseif mouseToTarget2 < sceneTable.mainMenu.dagensTip.radius and timer >= maxTimer then
                timer = 0
                sceneTxt = "Guide menu"
                scene = "guide"
            end
